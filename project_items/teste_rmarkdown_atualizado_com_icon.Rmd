...
## Adionar links, imagens e notas de rodapé no R Markdown
...
```
<br>
**Visualizar a Tabela com as 10 primeiras entradas de forma mais estética**
```{r}
library(knitr)
kable(head(iris, 10))
```
...
* escreva o seguinte código: `<link rel="shortcut icon" href=" coloque o link aqui"> <div> <img style="position:absolute; top:10px; right:50px; padding:10px;" src="coloque o link aqui" width="110" height="110" /> </div>` 
...
Para adicionar a logo, é escreva na parte **output** do cabeçalho: `includes:  in_header: "nome_do_arquivo.html"`.  
...
`<link rel="shortcut icon" href="https://i.imgur.com/SWWUQpP.png"> <div> <img style="position:relative; top:20px; left:50%; padding:10px;" src="https://i.imgur.com/SWWUQpP.png" width="510" height="150" /> </div>`  
...
* Mais uma vez, em um bloco de notas escreva o código `<link rel="shortcut icon" href="coloque o link aqui">`;  
* Salve em html;  
